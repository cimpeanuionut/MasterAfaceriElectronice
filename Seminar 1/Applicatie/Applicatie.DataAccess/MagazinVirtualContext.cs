...
namespace MagazinOnline.DataAcces.Entities
{
    public partial class MagazinVirtualContext : DbContext
    {
        public MagazinVirtualContext(DbContextOptions<MagazinVirtualContext> options) : base(options) {}
